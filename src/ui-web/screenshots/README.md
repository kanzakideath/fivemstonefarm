...
The PNG files in this directory are the historical v8.0.0 visual baseline. They are not the current v9.1.1 release UI and are not packaged into the application.
...
& scripts/ui-tests/Invoke-UiVisualTests.ps1 `
  ...
  -OutputDirectory artifacts/ui-tests/v9.1.1 `
